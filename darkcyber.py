...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang di tools Wisnu ID \033[1;92m" +nama+ "\n\033[1;97mTerimakasih telah menggunakan tools ini !!")
		time.sleep(3)
		loginSC()
...
def login():
	...
	try:
		...
		print "   Youtube: Wisnu ID"
		print "  github  : https://github,com/Wisnu2112"
		print "============================================"
		print 
...
def menu():
	...
	print 42*"\033[1;96m="
	print "\x1b[1;97m1.\x1b[1;93m Hack facebook "
